function p=confband2(x,y,Py,plottype,col,ax,level,conftype)
...
if conftype==2  % conf lines
    p(1)=feval(plottype,x,yupper,['--',col],'parent',ax);
    p(2)=feval(plottype,x,ylower,['--',col],'parent',ax);
else  % conf band
    ...
    p=patch2(xx,yy,cc,'facealpha',0.3,'parent',ax);
