...
%   Examples:
%
%   See also: ss.lss2ltf, ltf2lss, lss2ltf
...
%
%   See also: ss.fix, ltf.uncertain, ltf.estimate
...
%   y=impulse(G,T)
%   The analytical solution in ss.impulse is used
...
%
%   See also: ss.impulse, ltf.step, ltf.simulate
...
%   y=step(G,T)
%   The analytical solution in ss.step is used
...
%     subplot(2,1,2), plot(yc)
%
%   See also: ss.step, ltf.impulse, ltf.simulate
...
%     m=rand(ltf([2 1 1]))
%     tex(m)
%   See also: textable, texmatrix, ss.tex
...
function display(m)
%DISPLAY gives an ASCII-formatted printout of the LTF object
%   display(sys)  or  sys
format='%11.2g';
